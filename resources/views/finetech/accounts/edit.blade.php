<x-app-layout>
    ...
    <form action="{{ route('finetech.accounts.update', $account) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="card border-0 mb-3">
            <div class="card-body py-2 d-flex justify-content-between align-items-center">
                <span class="text-muted small">
                    ...
                    Editing account <strong>{{ $account->account_number }}</strong>
                </span>
                <div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="opening_balance" type="number" placeholder="0.00" value="{{ old('opening_balance', $account->opening_balance) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="opened_at" type="date" value="{{ old('opened_at', $account->opened_at?->format('Y-m-d')) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="closed_at" type="date" value="{{ old('closed_at', $account->closed_at?->format('Y-m-d')) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select name="status" id="status" class="form-select @error('status') is-invalid @enderror">
                            ...
                            <option value="dormant" {{ old('status', $account->status) == 'dormant' ? 'selected' : '' }}>Dormant</option>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="status_reason" id="status_reason" rows="2"
                                ...
                                placeholder="Reason for freezing/closing (if applicable)">{{ old('status_reason', $account->status_reason) }}</textarea>
                        </div>
                        @error('status_reason')
