...
<head>
    <meta charset="utf-8" />
    <title>Welcome | Finetech - Banking & Finance</title>
...
<body>
    ...
    <div class="layout-wrapper">
        ...
        <div class="main-menu">
            ...
            <!-- Left Sidebar Start -->
            @include('finetech.layouts._app.sidebar')
            <!-- Left Sidebar End -->
        ...
        <div class="page-content">
            ...
            <div class="navbar-custom">
                ...
                <!-- Topbar Start -->
                @include('finetech.layouts._app.topbar')
                <!-- end Topbar -->
            </div>
            <!-- ========== Topbar End ========== -->
            ...
            <!-- Footer Start -->
            @include('finetech.layouts._app.footer')
            <!-- end Footer -->
    ...
    <!-- END wrapper -->
    {{-- action::Begin --}}
    @include('finetech.layouts._app.actions')
    {{-- action::End --}}
