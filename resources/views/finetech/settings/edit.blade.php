<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('finetech.settings.update') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('contact_address') is-invalid @enderror"
                                ...
                                required>{{ old('contact_address', $setting->contact_address ?? '') }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                ...
                                required>{{ old('meta_description', $setting->meta_description ?? '') }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_keywords') is-invalid @enderror"
                                ...
                                required>{{ old('meta_keywords', $setting->meta_keywords ?? '') }}</textarea>
                            @error('meta_keywords')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
