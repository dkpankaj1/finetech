<x-app-layout>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h4 class="page-title mb-0">
                    <i class="fas fa-plus-circle me-2 text-primary"></i>Create KYC Document
                </h4>
            </div>
            <div class="col-lg-6">
    ...
    <form action="{{ route('finetech.kyc-documents.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card border-0 mb-3">
            <div class="card-body py-2 d-flex justify-content-between align-items-center">
                <span class="text-muted small">
                    <i class="fas fa-info-circle me-1"></i>Fill in all required fields to add a new KYC document.
                </span>
                <div>
                    <x-button text="Back" icon="back" variant="outline-secondary" href="{{ route('finetech.kyc-documents.index') }}" />
                    <x-button text="Create KYC Document" icon="add" variant="primary" />
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="document_number" placeholder="e.g. ABCDE1234F" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="expiry_date" type="date" class="border-start-0 ps-0" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        @error('front_image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Upload front side of the document (JPG, PNG, WEBP — max 2MB)</div>
                    </div>
                    <div class="col-md-6">
                        ...
                        @error('back_image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Upload back side of the document if applicable</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            <textarea name="remark" id="remark" rows="2"
                                ...
                                placeholder="Any remarks or reason for rejection">{{ old('remark') }}</textarea>
                        </div>
                        @error('remark')
