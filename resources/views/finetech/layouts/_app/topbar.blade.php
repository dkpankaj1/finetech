<div class="topbar">
    <div class="topbar-menu d-flex align-items-center gap-lg-2 gap-1">
        ...
        <!-- Brand Logo -->
        @include('finetech.layouts._app.logo')
    ...
    <ul class="topbar-menu d-flex align-items-center gap-2">
        ...
        @if (Session::get('theme', 'light') == 'dark')
            <li class="nav-link waves-effect waves-dark" onclick="document.getElementById('themesToggleForm').submit();">
        ...
        <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end profile-dropdown"
                ...
                <!-- item-->
                <a href="{{ route('finetech.profile.index') }}" class="dropdown-item notify-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        data-lucide="user" class="lucide lucide-user font-size-16 me-2">
                ...
                <!-- item-->
                <a href="{{ route('finetech.profile.update') }}" class="dropdown-item notify-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        data-lucide="settings" class="lucide lucide-settings font-size-16 me-2">
                        <path
                ...
                <!-- item-->
                <a href="{{ route('finetech.profile.password') }}" class="dropdown-item notify-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        data-lucide="lock" class="lucide lucide-lock font-size-16 me-2">
                ...
                <button class="dropdown-item notify-item"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        data-lucide="log-out" class="lucide lucide-log-out font-size-16 me-2">
