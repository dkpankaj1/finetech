        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h4 class="page-title mb-0">
                    <i class="fas fa-user-edit me-2 text-info"></i>Edit User
                </h4>
            </div>
            <div class="col-lg-6">
        ...
        <div class="card border-0 mb-3">
            <div class="card-body py-2 d-flex justify-content-between align-items-center">
                <span class="text-muted small">
                    ...
                    Editing <strong>{{ $user->name }}</strong> &mdash; Last updated {{ $user->updated_at->diffForHumans() }}.
                </span>
                <div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="name" placeholder="Enter full name" value="{{ $user->name }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="email" type="email" placeholder="example@email.com" value="{{ $user->email }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-check form-switch">
                            ...
                            <label class="form-check-label fw-semibold text-muted" for="togglePassword">
                                <i class="fas fa-key me-1"></i>Change Password
                            </label>
                        </div>
                    </div>

                    <div id="passwordFields" class="col-12" style="display:none;">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <x-input-label name="password" text="New Password" />
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0"><i class="fas fa-lock text-muted"></i></span>
                                    <x-input-field name="password" type="password" placeholder="Enter new password" class="border-start-0 ps-0" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <x-input-label name="password_confirmation" text="Confirm New Password" />
                                <div class="input-group">
                                    <span class="input-group-text bg-light border-end-0"><i class="fas fa-lock text-muted"></i></span>
                                    <x-input-field name="password_confirmation" type="password" placeholder="Re-enter new password" class="border-start-0 ps-0" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="aadhar_number" placeholder="xxxx-xxxx-xxxx" value="{{ $user->aadhar_number }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="phone_number" placeholder="+91-9700000000" value="{{ $user->phone_number }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="address" placeholder="Enter street address" value="{{ $user->address }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="city" placeholder="City" value="{{ $user->city }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="state" placeholder="State" value="{{ $user->state }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="postal_code" placeholder="e.g. 400001" value="{{ $user->postal_code }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="country" placeholder="Country" value="{{ $user->country }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                </div>
            </div>
