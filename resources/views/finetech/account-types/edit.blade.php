<x-app-layout>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h4 class="page-title mb-0">
                    <i class="fas fa-edit me-2 text-info"></i>Edit Account Type
                </h4>
            </div>
            <div class="col-lg-6">
    ...
    <form action="{{ route('finetech.account-types.update', $accountType) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="card border-0 mb-3">
            <div class="card-body py-2 d-flex justify-content-between align-items-center">
                <span class="text-muted small">
                    ...
                    Editing <strong>{{ $accountType->name }}</strong> &mdash; Last updated {{ $accountType->updated_at->diffForHumans() }}.
                </span>
                <div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="name" placeholder="e.g. Savings Account" value="{{ old('name', $accountType->name) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="code" placeholder="e.g. SAV" value="{{ old('code', $accountType->code) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="interest_rate" type="number" step="0.01" placeholder="e.g. 4.50" value="{{ old('interest_rate', $accountType->interest_rate) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="minimum_balance" type="number" step="0.01" placeholder="e.g. 500.00" value="{{ old('minimum_balance', $accountType->minimum_balance) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0"><i class="fas fa-coins text-muted"></i></span>
                            <x-input-field name="maximum_balance" type="number" step="0.01" placeholder="e.g. 1000000.00" value="{{ old('maximum_balance', $accountType->maximum_balance) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="daily_deposit_limit" type="number" step="0.01" placeholder="e.g. 50000.00" value="{{ old('daily_deposit_limit', $accountType->daily_deposit_limit) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="daily_withdrawal_limit" type="number" step="0.01" placeholder="e.g. 25000.00" value="{{ old('daily_withdrawal_limit', $accountType->daily_withdrawal_limit) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <x-input-field name="monthly_free_transactions" type="number" placeholder="e.g. 10" value="{{ old('monthly_free_transactions', $accountType->monthly_free_transactions) }}" class="border-start-0 ps-0" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="requires_kyc" id="requires_kyc" class="form-select @error('requires_kyc') is-invalid @enderror">
                            <option value="1" {{ old('requires_kyc', $accountType->requires_kyc) == '1' ? 'selected' : '' }}>Yes</option>
                            <option value="0" {{ old('requires_kyc', $accountType->requires_kyc) == '0' ? 'selected' : '' }}>No</option>
                        </select>
                        @error('requires_kyc')
