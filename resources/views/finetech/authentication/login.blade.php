            ...
            <div class="col-12">
                <div class="d-flex align-items-center min-vh-100">
                    <div class="w-100 d-block card shadow-lg rounded my-5 overflow-hidden">
                        <div class="row">
                            <div class="col-lg-5 d-none d-lg-block bg-login rounded-left" style="background-image:url('{{ asset('assets/backend/images/auth-bg.jpg') }}')"></div>
                            <div class="col-lg-7">
                                <div class="p-5">
                                    ...
                                    <form action="{{ route('finetech.login') }}" class="my-4" method="post">
                                        @csrf
